...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function init_template() {
        ...
        if (cardStack[0]) {
            ...
            var btnExpandCards =
                document.querySelectorAll(".btn-stack-click")[0];
            var cardStackClick =
                document.querySelectorAll(".card-stack-click")[0];
        ...
        function submenus() {
            ...
            if (subTrigger.length) {
                var submenuActive =
                    document.querySelectorAll(".submenu-active")[0];
                if (submenuActive) {
                    var subData = document
                        .querySelectorAll(".submenu-active")[0]
                        .getAttribute("data-submenu");
                    var subId = document.querySelectorAll("#" + subData);
                    var subIdNodes = document.querySelectorAll(
                        "#" + subData + " a"
                    );
        ...
        var autoActivateMenu = document.querySelectorAll(
            "[data-auto-activate]"
        )[0];
        if (autoActivateMenu) {
            setTimeout(function () {
        ...
        if (headerLarge) {
            ...
            headerLarge.innerHTML +=
                weekdayName[weekID.getDay()] +
                " " +
                dayName +
                daySuffix +
                " " +
                monthNames[monthID.getMonth()];
        }
                ...
                if (c in b && b[c]) {
                    ...
                    a.addEventListener(
                        ...
                        function (a) {
                            ...
                            "href" in d &&
                                (d.href.indexOf("http") ||
                                    ~d.href.indexOf(e.host)) &&
                                (a.preventDefault(), (e.href = d.href));
                        },
                        !1
                    );
                    document
                        .querySelectorAll(".page-content")[0]
                        .classList.add("is-on-homescreen");
                    setTimeout(function () {
                        document
                            .querySelectorAll("#footer-bar")[0]
                            .classList.remove("iosTabBar");
                    }, 50);
                }
        ...
        function pageHighlights() {
            ...
            highlightData.forEach((el) =>
                el.addEventListener("click", (e) => {
                    ...
                    loadHighlight.href =
                        "user/styles/highlights/" + highlight + ".css";
                    document
            ...
            if (rememberHighlight) {
                ...
                loadHighlight.type = "text/css";
                loadHighlight.href =
                    "user/styles/highlights/" + rememberHighlight + ".css";
