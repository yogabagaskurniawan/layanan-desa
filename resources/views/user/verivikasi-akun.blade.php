...
<div class="pt-3"></div>
<div class="card card-style mx-0 pb-4">
    <div class="container mt-4 px-3 mx-auto" style="max-width: 576px">
        <h3 class="text-center mb-1">Verifikasi Akun</h3>
            ...
            <form class="demo-animation needs-validation m-0" novalidate="">
                ...
                <div class="file-data ">
                    ...
                    <div class="text-center">
                        ...
                        <p class="mb-3 font-12">Maksimal ukuran foto 3MB</p>
                    </div>
                </div>          
                <button class="btn btn-full bg-mint-dark rounded-xs text-uppercase font-700 w-100 btn-xxs mt-4" type="submit">Update</button>
            </form>
        {{-- </div> --}}
    </div>
</div>
