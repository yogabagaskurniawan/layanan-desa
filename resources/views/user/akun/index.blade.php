        ...
        <div class="container mt-4 px-3 mx-auto" style="max-width: 576px">
            <form class="demo-animation needs-validation m-0" novalidate="">
                <div class="form-custom mb-3 form-border form-icon form-label">
                    ...
                    <input type="text" class="form-control rounded-xs" placeholder="password lama" id="c1" pattern="[A-Za-z ]{1,32}" required="">
                    <label for="c1" class="color-theme">Password Lama</label>
                    <div class="valid-feedback">Excellent!<!-- text for field valid--></div>
                    <div class="invalid-feedback">Name is Missing or Invalid</div>
                </div>
                <div class="form-custom mb-3 form-border form-icon form-label">
                    <i class="bi bi-key font-14"></i>
                    <input type="text" class="form-control rounded-xs" placeholder="password baru" id="c1" pattern="[A-Za-z ]{1,32}" required="">
                    <label for="c1" class="color-theme">Password Baru</label>
                    <div class="valid-feedback">Excellent!<!-- text for field valid--></div>
                    <div class="invalid-feedback">Name is Missing or Invalid</div>
                </div>
                <div class="form-custom mb-3 form-border form-icon form-label">
                    <i class="bi bi-lock font-12"></i>
                    <input type="tel" class="form-control rounded-xs" id="c3" placeholder="konfirmasi password baru" pattern="[+ 0-9]{10,15}" required="">
                    <label for="c3" class="color-theme">Konfirmasi Passeord Baru</label>
