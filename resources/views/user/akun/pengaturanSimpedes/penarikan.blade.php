...
<div class="header-bar header-fixed header-app header-auto-show m-auto" style="max-width: 1000px !important;">
    ...
    <a class="header-title">Nasabah penarikan</a>
    ...
    <div class="content mt-0">
        <div class="align-self-center" style="margin: 0; padding: 0;">
            ...
            <div class="d-flex justify-content-center">
                <a href="/simpedes-nasabah-detail" class="btn btn-xxs bg-blue-dark shadow-bg-m text-center py-1 my-2">Detail Lengkap </a>
            </div>
            <div class="divider my-2"></div>
        ...
        <div class="divider my-2"></div>
        <div class="my-3 d-flex justify-content-center">
            <button class="btn btn-xxs btn-success mx-1" type="submit" onclick="return confirm('konfirmasi pendaftaran?')">Konfirmasi penarikan</button>
            <button class="btn btn-xxs btn-danger mx-1" type="submit" onclick="return confirm('konfirmasi pendaftaran?')">Hapus penarikan</button>
        </div>
    </div>
</div>
@endsection
...
<div class="pt-3">
    <div class="page-title d-flex pb-3">
        ...
        <div class="align-self-center me-auto">
            <h1 class="color-theme mb-0 font-18">Nasabah penarikan</h1>
        </div>
    </div>
</div>
