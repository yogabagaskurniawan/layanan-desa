...
<div class="card card-style">
    <div class="content">
        <h4 class="m-auto text-center">Nomor Petugas</h4>
        <form class="demo-animation needs-validation m-0" novalidate="">
            <div class="form-custom form-label form-icon mb-3">
                <input type="number" class="form-control rounded-xs" id="c3" placeholder="+1 234 567 315" pattern="[+ 0-9]{10,15}" value="12335" required="">
...
<div class="card card-style">
    <div class="content">
        <h4 class="m-auto text-center">Nomor Deposit</h4>
        <form class="demo-animation needs-validation m-0" novalidate="">
            <div class="form-custom form-label form-icon mb-3">
                <input type="number" class="form-control rounded-xs" id="c3" placeholder="+1 234 567 315" pattern="[+ 0-9]{10,15}" value="12335" required="">
                <label for="c3" class="color-theme">Your Number</label>
...
<div class="card card-style">
    <div class="content">
        <h4 class="m-auto text-center">Minimal Penarikan</h4>
        <form class="demo-animation needs-validation m-0" novalidate="">
            <div class="form-custom form-label form-icon mb-3">
                <input type="number" class="form-control rounded-xs" id="c3" placeholder="+1 234 567 315" pattern="[+ 0-9]{10,15}" value="12335" required="">
                <label for="c3" class="color-theme">Your Number</label>
