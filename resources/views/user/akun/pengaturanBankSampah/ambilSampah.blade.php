...
<div class="header-bar header-center shadow-m">
    <h2 class="m-auto">Pengambilan Sampah List Nasabah</h2>
</div>
              ...
              <tbody>
                <tr class="border-fade-blue">
                  ...
                  <td class="text-center">
                    <button class="btn btn-xxs bg-blue-dark" type="submit" onclick="return confirm('Sudah diambil?')">Ambil sampah</button>
                  </td>
...
{{-- <div id="menu-modal-window" style="height: 530px; width: 340px; display: block;" class="offcanvas offcanvas-modal rounded-m ">
    <div class="header-bar header-center shadow-m">
        <h2 class="m-auto">Detail Nasabah</h2>
        <button class="btn btn-close p-1 ms-auto" type="button" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
