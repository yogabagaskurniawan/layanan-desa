...
<div class="header-bar header-fixed header-app header-auto-show m-auto" style="max-width: 1000px !important;">
    ...
    <a class="header-title">Pengambilan sampah</a>
...
<div class="pt-3">
    <div class="page-title d-flex pb-3">
        ...
        <div class="align-self-center me-auto">
            <h1 class="color-theme mb-0 font-18">Pengambilan sampah</h1>
        </div>
    </div>
</div>
            ...
            <div class="border border-blue-dark rounded-xs overflow-hidden">
                <table class="table color-theme border-blue-dark mb-0">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <a href="#" class="" data-bs-toggle="offcanvas" data-bs-target="#menu-top-full">
                                    Slamet
                                </a>
                            </td>
                            <td>02</td>
                            <td>05</td>
                            <td>
                                <button class="border-0 badge bg-primary bg-primary-dark px-2 rounded-s font-12" type="submit" onclick="return confirm('Sudah diambil?')">
                                    Ambil sampah
                                </button>
                            </td>
                        </tr>
