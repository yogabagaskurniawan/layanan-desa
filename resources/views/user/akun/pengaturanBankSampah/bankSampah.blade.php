...
<div class="card card-style mx-0">
    <h2 class="m-auto mt-3">Pengaturan Bank Sampah</h2>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-12 text-center">
                        <h2 class="text-center font-500 mt-2 font-20">Fitur</h2>
                    </div>
                    <div class="col-6 position-relative">
                      <a href="/bankSampah-ambilSampah">
                        <div class="feature-card mx-auto text-center">
                            <img src="{{ asset('user/images/bank-sampah.png')}}" alt="" style="width: 32px; height: 32px; object-fit: cover;">
                            <span class="position-absolute top-0 start-60 translate-middle badge rounded-pill bg-danger">1</span>
                    ...
                    <div class="col-6">
                        <a href="/bankSampah-pembayaran">
                          <div class="feature-card mx-auto text-center">
                              <img src="{{ asset('user/images/payment.png')}}" alt="" style="width: 32px; height: 32px; object-fit: cover;">
                      ...
                      <div class="col-6">
                        <a href="/bankSampah-historyPembayaran">
                          <div class="feature-card mx-auto text-center">
                              <img src="{{ asset('user/images/informasi.png')}}" alt="" style="width: 32px; height: 32px; object-fit: cover;">
