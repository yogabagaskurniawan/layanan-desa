...
<div class="header-bar header-fixed header-app header-auto-show m-auto" style="max-width: 1000px !important;">
    ...
    <a class="header-title">Pendaftaran nasabah baru</a>
...
<div id="menu-top-full"  style="height: 100%; display: block;max-width: 1000px;" class="offcanvas offcanvas-top m-auto" aria-modal="true" role="dialog">
    ...
    <div class="content mt-0">
        <div class="align-self-center" style="margin: 0; padding: 0;">
            ...
            <p style="margin: 0;">RT : 01</p>
            <p style="margin: 0;">RW : 09</p>
        ...
        <div class="divider my-2"></div>
        <div class="my-3 d-flex justify-content-center">
            <button class="btn btn-xxs btn-success mx-1" type="submit" onclick="return confirm('konfirmasi pendaftaran?')">Konfirmasi Pendaftaran</button>
            <button class="btn btn-xxs btn-danger mx-1" type="submit" onclick="return confirm('konfirmasi pendaftaran?')">Hapus Pendaftaran</button>
        </div>  
    </div>
</div>
@endsection
...
<div class="pt-3">
    <div class="page-title d-flex pb-3">
        ...
        <div class="align-self-center me-auto">
            <h1 class="color-theme mb-0 font-18">Pendaftaran nasabah baru</h1>
        </div>
    </div>
</div>
