        ...
        <div class="mx-auto" style="max-width: 576px">
            <form class="demo-animation needs-validation m-0" novalidate="">
                <div class="form-custom form-label form-icon mb-3">
                    <input type="number" class="form-control rounded-xs" id="c3" placeholder="12345" value="20000" pattern="[+ 0-9]{10,15}" required="">
                    <label for="c3" class="color-theme form-label-active">Biaya Pengambilan</label>
