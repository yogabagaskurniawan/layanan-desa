...
<div class="header-bar header-center shadow-m">
    <h2 class="m-auto">Histori Pengambilan</h2>
</div>
...
<div id="menu-modal-window" style="height: 430px; width: 340px; display: block;" class="offcanvas offcanvas-modal rounded-m ">
    <div class="header-bar header-center shadow-m">
    ...
    <div class="d-flex m-3">
        <div class="align-self-center" style="margin: 0; padding: 0;">
            ...
            <p style="margin: 0;">Petugas Pengambilan : Admin</p>
            <hr>
            <h5>Data Akun</h5>
            <hr>
        </div> 
