...
<div class="card card-style mx-0 pb-4 rounded-0" style="border-bottom-right-radius: 26px !important;border-bottom-left-radius: 26px !important">
    ...
    <div class="container mt-4 px-3 mx-auto" style="max-width: 576px">
        <h3 class="text-center mb-1">Isi Saldo</h3>
        <p class="mb-4 text-center">Petugas Simpedes akan datang kerumah Anda</p>
        <form class="demo-animation needs-validation m-0" novalidate="">
            <div class="form-custom mb-3 form-icon form-floating">
                ...
                <label for="c1" class="color-theme">Jumlah Isi Saldo</label>
            ...
            <button class="btn btn-full bg-mint-dark rounded-xs text-uppercase font-700 w-100 btn-xxs my-4" type="submit">Isi Saldo</button>
        </form>
        <p class="mb-2 text-center">Pengisian Saldo sebesar Rp 15,000 dalam proses,<br> mohon tunggu petugas kerumah Anda.</p>
        <div class="text-center">
            ...
            <h3 class="mb-3 pt-3">Riwayat Pengisisan Saldo</h3>
            <form action="">
