    ...
    <div class="content">
        <form class="demo-animation needs-validation m-0" novalidate="">
            ...
            <div class="form-custom mb-3 form-border form-icon form-label">
                ...
                <label for="c7" class="color-theme">Your Address</label>
            ...
            <div class="form-custom mb-3 form-border form-icon form-label">
                ...
                <label for="c3" class="color-theme">Your Cost</label>
            ...
            <div class="form-custom mb-3 form-border form-icon form-label">
                ...
                <textarea class="form-control rounded-xs" placeholder="Description excemple" id="c7"></textarea>
