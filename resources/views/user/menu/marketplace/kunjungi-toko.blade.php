...
<div class="pt-3 sticky-nav">
    <div class="page-title pb-3 d-flex align-items-center mx-0" style="max-width: 1000px !important;">
        <div class="me-auto align-self-center">
            <a href="/marketplace/detail-produk" class="me-3 ms-0 icon icon-xs bg-theme rounded-s shadow-m">
...
<div class="pt-3"></div>
<div class="card card-style overflow-visible mt-5 mx-0 rounded-0" style="border-bottom-right-radius: 22px !important;border-bottom-left-radius: 22px !important">
    <div class="mt-n5"></div>
    <img src="{{ asset('user/images/pictures/kurir1.jpeg') }}" class="img-fluid mx-auto rounded-circle border border-m border-theme" width="100" style="height: 100px;">
    <div class="content mt-0 mb-2">
        <h2 class="pt-3">Asus.Official <span class="badge bg-success rounded-s px-2 mb-1 mx-2 font-14" style="vertical-align: middle;">Aktif</span></h2>
